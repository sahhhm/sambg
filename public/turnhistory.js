...
* -------------------------------------------
*/
var AMove = Class.extend({
    init: function( confirmedRolls, player, from, fromType, to, toType, isToHit, diceValue ) {
...
var TurnHistory = Class.extend({
    ...
    clearCurrentToHistory: function() {
      this.history.push(this.currentTurn);
      this.currentTurn = [];
    },
    getTurnsByNo: function(turnNo) {
